define("testing-bundle", ["statcan_viz_ext_testing-src/js/flow", "css!statcan_viz_ext_testing-src/style/default.css"], function(
		...
		"components": [{
			...
			"customProperties": {
				...
				"resources": [{
					...
					"path": "./statcan_viz_ext_testing-src/resources/templates"
				}]
			}
		}]
	});
